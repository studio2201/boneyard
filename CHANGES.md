...
- Native `$GITHUB_STEP_SUMMARY` Markdown scorecard and debt budget audit reporting.
- Human-first 'Why This Action Is Needed' rationale with Stripe/Gartner debt citations.
